// import { parseTableParams, pickNotDeprecated, setInitialFilters, setInitialSorters, stringifyTableParams, unionFilters, unionSorters, useGo, useList, useLiveMode, useMeta, useNavigation, useParsed, useResource, useRouterContext, useRouterType, useSyncWithLocation, type BaseRecord, type CrudFilter, type CrudSort, type GetListResponse, type HttpError, type LiveModeProps, type MetaQuery, type Pagination, type Prettify, type SuccessErrorNotification, type UseLoadingOvertimeOptionsProps, type UseLoadingOvertimeReturnType } from "@refinedev/core";
// import type { UseQueryOptions, QueryObserverResult } from "@tanstack/react-query";
// import { differenceWith, isEqual } from "lodash-es";
// import type { BaseListProps } from "node_modules/@refinedev/core/dist/hooks/data/useList";
// import qs from "qs";
...
//   const getCurrentQueryParams = useCallback((): object => {
//     if (routerType === "new") {
...
//     return rest;
//   }, [parsedParams?.params, routerType, search]);
...
//       }
//     }
//   }, [syncWithLocation, current, pageSize, sorters, filters, getCurrentQueryParams, routerType, go, isPaginationEnabled, preferredPermanentSorters, preferredPermanentFilters, replace, pathname]);
