...
import { useUpdate, useOne, useGo, CanAccess } from '@refinedev/core';
...
const EditPost: React.FC = () => {
  ...
  // Xử lý submit form
  const handleSubmit = async (values: { title: string; summary: string }) => {
    if (!content.trim()) {
            ...
            <div className='bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-auto'>
              ...
              <div className='p-6'>
                ...
                <div className='text-gray-500 mb-4'>
                  Tác giả: {previewData.creator?.name} •{' '}
                  {new Date(previewData.created_at).toLocaleDateString('vi-VN')}
                </div>
